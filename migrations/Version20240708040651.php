 ...
 */
final class Version20240708040651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bon_de_commande_user (bon_de_commande_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_B4A2D040D29E677C (bon_de_commande_id), INDEX IDX_B4A2D040A76ED395 (user_id), PRIMARY KEY(bon_de_commande_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
